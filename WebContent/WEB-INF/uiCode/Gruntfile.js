			...
			concat:{
				...
				js:{
					src:[ '<%= js_src_path %>/js/app.js','<%= js_src_path %>/expired/**/*.js','<%= js_src_path %>/login/**/*.js',
						'<%= js_src_path %>/newReminder/**/*.js','<%= js_src_path %>/contacts/**/*.js','<%= js_src_path %>/home/**/*.js','<%= js_src_path %>/util/**/*.js' ],
		...
		replace: {
			...
			ngtemplates: {
				myapp: {
				 ...
				 cwd:     '<%= js_src_path %>',
				 //src: "<%= js_src_path %>",
				 src: ["tabs.html","menu.html","contacts/**/*.html", "expired/**/*.html","login/**/*.html" , "newReminder/**/*.html" ,"home/**/*.html","util/**/*.html"],
